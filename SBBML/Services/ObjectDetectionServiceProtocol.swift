...
public protocol ObjectDetectionServiceProtocol {
    ...
    var detectedObjectsStream: AsyncStream<[DetectedObject]> { get }
    ...
    var errorStream: AsyncStream<ObjectDetectionError?> { get }
    ...
    var currentObjectDetectionInferenceTimeStream: AsyncStream<TimeInterval> { get }
